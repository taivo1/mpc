...
$html=' <div class="title">About</div>
        <div class="title2">About</div>
        <div class="plugin_content">
Meshlium Manager System is the Open Source router web manager designed by <a href="http://www.libelium.com">Libelium</a>.<br />
This web application is optimized to get the most of the <a href="http://www.libelium.com/products/meshlium">Meshlium</a> router, although it can be used in other network hardware with Linux system.<br />
This software is Open Source and the code is released under the terms of the <a href="http://www.gnu.org/licenses/gpl-2.0.html#SEC1">GPL2 License</a>.
        </div>
        <div class="title2">Version</div>
        <div class="plugin_content">
Meshlium Manager System v.'.$manager_system_version.'
        </div>
        <div class="title2">Documentation and resources</div>
        <div class="plugin_content">
<a href="http://www.libelium.com/development/meshlium/msystem-index">Documentation</a>
<br />
<a href="http://www.libelium.com/development/meshlium">Resources for developers</a>
        </div>';
