...
$plugin_name="Crontab"; // THIS SHOULD BE A LINE.
$plugin_version="0.1"; // THIS SUOULD BE A LINE.
$plugin_author="Octavio Bened&iacute;"; //THIS SHOULD BE A LINE.
$plugin_description="Meshlium's crontab editor"; // THIS SHOULD BE A SMALL DESCRIPTION
...
$plugin_icon="images/cron.png"; // BY DEFAULT
$plugin_icon_selected="images/cron_hv.png"; // BY DEFAULT
?>