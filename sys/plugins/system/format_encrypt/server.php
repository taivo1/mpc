...
if (!empty($_POST['action']))
{
    ...
    {
        case "encrypt":
            include_once $base_plugin.'php/encrypt.php';
            encrypt_user_partition($post_data);
            response_return();
            break;
        case "mount":
            include_once $base_plugin.'php/mount.php';
            mount_user_partition($post_data);
            response_return();
            break;
        case "format":
            include_once $base_plugin.'php/format.php';
            format_user_partition($post_data);
            response_return();
            break;
        default:
            break;
