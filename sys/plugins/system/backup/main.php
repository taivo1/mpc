...
// plugins/section_name/plugin_name/javascript/plugin1.js
$_plugin_javascript=Array("jquery-1.3.2.min.js","jquery.ocupload-1.1.2.packed.js","ajax.js","form_fields_check.js");
...
include_once $API_core.'/parser_remote_server.php';
   /*
   $mtime = microtime();
   $mtime = explode(" ",$mtime);
   ...
   $starttime = $mtime;
   */
$html='<div class="title">BACKUP</div>
        <div id="backup_interface" class="plugin_content">';
$html.=make_interface();
$html.='</div>';
   /*
   $mtime = microtime();
