...
$_main_title="System Information";
...
<div class="title2">OS Version</div>
<div class="plugin_content">
'.implode('</br>',$os_version).'</div>
<div class="title2">Server Date &amp; Timezone</div>
<div class="plugin_content">
'.implode($current_date).'</div>

<div class="title2">Uptime</div>
<div class="plugin_content">
'.implode($uptime).'</div>

<div class="title2">Network</div>
<div class="plugin_content"><pre>
'.implode('<br/>', $ifconfig).'</pre></div>

<div class="title2">Memory</div>
<div class="plugin_content"><pre>
'.implode('<br/>', $free).'</pre></div>

<div class="title2">Disk Usage</div>
<div class="plugin_content"><pre>
'.implode('<br/>', $disk_usage).'</pre></div>
</div>
