...
$plugin_name="System Info"; // THIS SHOULD BE A LINE.
$plugin_version="1.0.0"; // THIS SUOULD BE A LINE.
$plugin_author="Punky Tse"; //THIS SHOULD BE A LINE.
$plugin_description="Display System Infomation"; // THIS SHOULD BE A SMALL DESCRIPTION
