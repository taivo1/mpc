...
$plugin_name="Hostname"; // THIS SHOULD BE A LINE.
$plugin_version="0.1"; // THIS SUOULD BE A LINE.
$plugin_author="Octavio Bened&iacute;"; //THIS SHOULD BE A LINE.
$plugin_description="Allows to modify meshlium hostname"; // THIS SHOULD BE A SMALL DESCRIPTION
...
$plugin_icon="images/hostname.png"; // BY DEFAULT
$plugin_icon_selected="images/hostname_hv.png"; // BY DEFAULT
?>