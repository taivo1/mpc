...
{
    $fresnel_configuration=jsondecode($_POST['form_fields']);
    save_data($fresnel_configuration, $_POST['interface']);
    //response_additem("return", '<pre>'.print_r($fresnel_configuration,true).'</pre>');
