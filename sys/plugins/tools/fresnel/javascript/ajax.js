...
// own ajax call.
function complex_ajax_call(form_id,output_id,section,plugin,inter)
{
    ...
    submit_data="section="+section+"&plugin="+plugin+"&type=complex&interface="+inter+"&form_fields="+json_field;
    //alert (submit_data);
