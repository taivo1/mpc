...
$plugin_name="Traceroute"; // THIS SHOULD BE A LINE.
$plugin_version="0.1"; // THIS SUOULD BE A LINE.
$plugin_author="Octavio Bened&iacute;"; //THIS SHOULD BE A LINE.
$plugin_description="Allows to do traceroute over network"; // THIS SHOULD BE A SMALL DESCRIPTION
...
$plugin_icon="images/traceroute.png"; // BY DEFAULT
$plugin_icon_selected="images/traceroute_hv.png"; // BY DEFAULT
?>