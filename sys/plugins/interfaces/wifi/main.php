...
// plugins/section_name/plugin_name/javascript/plugin1.js
$_plugin_javascript=Array("jquery-1.3.2.min.js","jquery.json-1.3.min.js","json_encode.js","ajax.js","control_actions.js","load_interface.js","form_fields_check.js");
...
$html.=make_selector('/etc/network/interfaces','ath0');
//$html.='</div>';
//$html.='<div style="float:left;width:50%">';
//$html.='<form id="ath1" name="ath1">'.make_wireless($input,'/etc/network/interfaces','ath1').'</form>';
//$html.='</div>';
