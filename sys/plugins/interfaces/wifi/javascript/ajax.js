...
// own ajax call.
function complex_ajax_call(form_id,output_id,section,plugin,action,inter)
{
    ...
    if(!ms_check_form_fields())
    {
        ...
        submit_data="section="+section+"&plugin="+plugin+"&type=complex&interface="+inter+"&action="+action+"&form_fields="+json_field;
        //alert (submit_data);
