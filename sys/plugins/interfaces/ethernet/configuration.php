...
$plugin_name="Ethernet"; // THIS SHOULD BE A LINE.
$plugin_version="0.1"; // THIS SUOULD BE A LINE.
$plugin_author="Octavio Bened&iacute;"; //THIS SHOULD BE A LINE.
$plugin_description="Ethernet interface management"; // THIS SHOULD BE A SMALL DESCRIPTION
...
$plugin_icon="images/ethernet.png"; // BY DEFAULT
$plugin_icon_selected="images/ethernet_hv.png"; // BY DEFAULT
?>
